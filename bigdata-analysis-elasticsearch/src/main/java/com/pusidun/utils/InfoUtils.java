...
public class InfoUtils {
    ...
    private static String[] keyWords = {"男上衣森马", "男运动鞋", "阿迪达斯", "内裤", "裙子", "华为手机", "医用口罩", "良品铺子"};
    private static String[] brands = {"森马", "阿迪达斯", "小米", "vivo", "华为", "周黑鸭", "良品铺子", "特步", "安踏", "李宁", "乔丹"};
    ...
    public static String getSearchWords() {
        int index = getNum(0, keyWords.length - 1);
    ...
    public static String getBrand() {
        int index = getNum(0, brands.length - 1);
        return brands[index];
    }
    ...
    public static String getURL() {
        int index = getNum(0, urls.length - 1);
        return urls[index];
    }
